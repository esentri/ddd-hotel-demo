 ...
 * Hierbei handelt es sich hauptsächlich um Identifikatoren für Hotel, Zimmer, Buchung, Gast und ServiceLeistung.
 *
...
public enum TestDataIds {
    ...
    GAST_BUCHUNG_EINGECHECKT_ID(new Gast.GastId(UUID.randomUUID())),
