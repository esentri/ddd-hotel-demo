...
/**
 * Repräsentiert den Befehl zum Erstellen einer Rechnung für eine Buchung.
 * Beinhaltet eine BuchungsNummer, eine Liste von Service-Leistungen und eine Rechnungsadresse.
 *
 * @author Mario Herb
 ...
 * @see Adresse
 */
public record ErstelleRechnungFuerBuchung(Buchung.BuchungsNummer buchungsNummer,
